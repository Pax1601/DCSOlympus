module.exports = function (configLocation) {
	...
	const groundUnitDatabase = require(path.join(path.dirname(configLocation),'../Mods/Services/Olympus/databases/units/groundunitdatabase.json'));
	const navyUnitDatabase = require(path.join(path.dirname(configLocation),'../Mods/Services/Olympus/databases/units/navyunitdatabase.json'));
