        ...
        <Menu title="Formation menu" open={props.open} showBackButton={false} onClose={props.onClose}>
            <div className="flex h-full flex-col gap-4 p-4">
                ...
                <div className="flex gap-2">
                    <OlDropdown label={formationTypes[formationType as keyof typeof formationTypes]} className={`
                      w-full
                    `}>
                            ...
                            .map((optionFormationType) => {
                                return (
                                    <OlDropdownItem key={optionFormationType} onClick={() => setFormationType(optionFormationType)}>
                                        {formationTypes[optionFormationType as keyof typeof formationTypes]}
                                    </OlDropdownItem>
                                );
                            })}
                    </OlDropdown>
                    <button
                        ...
                        className={`
                          mb-2 rounded-lg bg-blue-700 px-5 py-2.5 text-md
                ...
                <button
                    ...
                    className={`
                      rounded-lg bg-blue-700 px-5 py-2.5 text-md font-medium
                      text-white
                      dark:bg-blue-600 dark:hover:bg-blue-700
                      dark:focus:ring-blue-800
                      focus:outline-none focus:ring-4 focus:ring-blue-300
