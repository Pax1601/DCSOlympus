...
export function UnitControlMenu(props: { open: boolean; onClose: () => void }) {
    ...
    /* Expand the custom string json if possible */
    const customString = selectedUnits.length > 0 ? selectedUnits[0].getCustomString() : "";
    const customInteger = selectedUnits.length > 0 ? selectedUnits[0].getCustomInteger() : 0;

    // Check if customString is a valid JSON
    ...
    return (
        <Menu
            ...
            wiki={() => {
                return (
                    <div
                        className={`
                          h-full flex-col overflow-auto p-4 text-gray-400
                          no-scrollbar flex gap-2
                        `}
                    >
                        <h2 className="mb-4 font-bold">Unit selection tool</h2>
                        <div>
                            The unit control menu serves two purposes. If no unit is currently selected, it allows you to select units based on their category,
                            coalition, and control mode. You can also select units based on their specific type by using the search input.
                        </div>
                        <h2 className="my-4 font-bold">Unit control tool</h2>
                        <div>
                            If units are selected, the menu will display the selected units and allow you to control their altitude, speed, rules of engagement,
                            and other settings.
                        </div>
                        <div>
                            The available controls depend on what type of unit is selected. Only controls applicable to every selected unit will be displayed,
                            so make sure to refine your selection.{" "}
                        </div>
                        <div>
                            {" "}
                            You will be able to inspect the current values of the controls, e.g. the desired altitude, rules of engagement and so on. However,
                            if multiple units are selected, you will only see the values of controls that are set to be the same for each selected unit.
                        </div>
                        <div>
                            {" "}
                            For example, if two airplanes are selected and they both have been instructed to fly at 1000ft, you will see the altitude slider set
                            at that value. But if one airplane is set to fly at 1000ft and the other at 2000ft, you will see the slider display 'Different
                            values'.
                        </div>
                        <div> If at that point you move the slider, you will instruct both airplanes to fly at the same altitude.</div>
                        <div>
                            {" "}
                            If a single unit is selected, you will also be able to see additional info on the unit, like its fuel level, position and altitude,
                            tasking, and available ammunition.{" "}
                        </div>
                    </div>
                );
            }}
        >
                    ...
                    <div className="flex flex-col gap-4 p-4">
                        ...
                        <div className="flex content-center gap-4">
                            ...
                            <div className="text-sm text-gray-400">
                                The selection tools allows you to select units depending on their category, coalition, and control mode. You can also select
                                units depending on their specific type by using the search input.
                            </div>
                        </div>
                        <div
                            className={`
                              flex flex-col gap-4 rounded-lg bg-olympus-600 p-4
                            `}
                        >
                            {selectionID === null && (
                                <>
                                    <div
                                        className={`
                                          text-bold border-b-2 border-b-white/10
                                          pb-2 text-gray-400
                                        `}
                                    >
                                        Control mode
                        ...
                        <button
                            type="button"
                            className={`
                              mb-2 me-2 rounded-lg bg-blue-700 px-5 py-2.5
            ...
            <>
                ...
                {selectedUnits.length > 0 && (
                    <>
                        {Object.keys(unitOccurences["blue"]).length +
                            Object.keys(unitOccurences["neutral"]).length +
                            Object.keys(unitOccurences["red"]).length >
                            1 && (
                            <div
                                className={`
                                  mb-2 flex gap-4 p-2 px-5 text-sm text-gray-400
                                `}
                            >
                                {" "}
                                <FaQuestionCircle
                                    className={`
                                  my-auto min-w-6 text-base
                                `}
                                />{" "}
                                <div className="flex flex-col gap-0.5">
                                    ...
                                    <div>
                                        <kbd
                                            className={`
                                              my-auto ml-auto text-nowrap
                                              rounded-lg border border-gray-200
                                              bg-gray-100 px-2 py-0.5 text-xs
                        ...
                        <>
                                ...
                                <div className="flex flex-col gap-5 p-5">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <FontAwesomeIcon
                                                                                ...
                                                                                `}
                                                                            />{" "}
                                                                            rules of engagement, so be careful, they may start shooting when you don't want them
                                                                            to. Use neutral units for finer control.
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            }
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <FontAwesomeIcon
                                                                            ...
                                                                            `}
                                                                        />{" "}
                                                                        Green: The unit will not engage with its sensors in any circumstances. The unit will be
                                                                        able to move.
                                                                    </div>
                                                                    <div
                                                                        className={`
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <FontAwesomeIcon
                                                                            ...
                                                                            `}
                                                                        />{" "}
                                                                        Red: The unit will be actively searching for target with its sensors. For some units,
                                                                        this will deploy the radar and make the unit not able to move.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        }
                                        ...
                                        <>
                                            ...
                                            <div className={`flex flex-col gap-2`}>
                                                ...
                                                <OlButtonGroup
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <FontAwesomeIcon
                                                                                ...
                                                                                `}
                                                                            />{" "}
                                                                            Manouevre: The unit will try to evade the threat using manoeuvres, but no
                                                                            counter-measures
                                                                        </div>
                                                                        <div
                                                                            className={`
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <FontAwesomeIcon
                                                                                ...
                                                                                `}
                                                                            />{" "}
                                                                            Full evasion: the unit will try to evade the threat both manoeuvering and using
                                                                            counter-measures
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    tooltipRelativeToParent={true}
                                                >
                                                    {[olButtonsThreatNone, olButtonsThreatPassive, olButtonsThreatManoeuvre, olButtonsThreatEvade].map(
                                                        (icon, idx) => {
                                                            return (
                                                                <OlButtonGroupItem
                                                                    key={idx}
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                >
                                                    {[olButtonsEmissionsSilent, olButtonsEmissionsDefend, olButtonsEmissionsAttack, olButtonsEmissionsFree].map(
                                                        (icon, idx) => {
                                                            return (
                                                                <OlButtonGroupItem
                                                                    key={idx}
                                    ...
                                    {selectedUnits.length === 1 && (selectedUnits[0].isTanker() || selectedUnits[0].isAWACS()) && (
                                        ...
                                        >
                                            ...
                                            >
                                                <FaCog className="my-auto" />{" "}
                                                {selectedUnits[0].isTanker() ? "Configure tanker settings" : "Configure AWACS settings"}
                                            </button>
                                        </div>
                                    )}
                                                    ...
                                                    {showScenicModes && (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <div>
                                                                    Currently, DCS blue and red ground units do not respect their rules of engagement, so be
                                                                    careful, they may start shooting when you don't want them to. Use neutral units for finer
                                                                    control, then use the "Operate as" toggle to switch their "side".
                                                                </div>
                                                            </div>
                                                        </div>
                                                    )}
                            ...
                            {showRadioSettings && (
                                <div
                                    className={`
                                      flex flex-col gap-2 p-4 text-white
                                    `}
                                >
                                            ...
                                            label={
                                                selectedUnits[0].isAWACS()
                                                    ? ["Overlord", "Magic", "Wizard", "Focus", "Darkstar"][
                                                          activeRadioSettings ? activeRadioSettings.radio.callsign - 1 : 0
                                                      ]
                                        ...
                                        <OlNumberInput
                                            ...
                                            onChange={(e) => {
                                                if (activeRadioSettings)
                                                    activeRadioSettings.radio.callsignNumber = Math.max(Math.min(Number(e.target.value), 9), 1);
                                                setActiveRadioSettings(deepCopyTable(activeRadioSettings));
                                            }}
                                            onDecrease={() => {
                                                if (activeRadioSettings)
                                    ...
                                    <div className="flex pt-8">
                                        <button
                                            className={`
                                              mb-2 me-2 rounded-sm bg-blue-700
                                              px-5 py-2.5 text-md font-medium
                                              text-white
                                              dark:bg-blue-600
                                              dark:hover:bg-blue-700
                                              dark:focus:ring-blue-800
                                        ...
                                        <button
                                            className={`
                                              mb-2 me-2 rounded-sm border-[1px]
                                              border-gray-600 bg-blue-700 px-5
                                              py-2.5 text-md font-medium
                                              text-gray-400
                                              dark:bg-transparent
                                        ...
                                        <OlToggle
                                            onClick={() => {
                                                setActiveAdvancedSettings({
                                                    ...
                                                    prohibitAA: !activeAdvancedSettings?.prohibitAA,
                                                });
                                            }}
                                    ...
                                    >
                                        ...
                                        <OlToggle
                                            onClick={() => {
                                                setActiveAdvancedSettings({
                                                    ...(activeAdvancedSettings as GeneralSettings),
                                                    prohibitAG: !activeAdvancedSettings?.prohibitAG,
                                                });
                                            }}
                            ...
                            {selectedUnits.length === 1 && (
                                <div
                                    className={`
                                      ...
                                      border-l-olympus-100 bg-olympus-600 p-4
                                    `}
                                >
                                    <div
                                        className={`
                                    ...
                                    >
                                        ...
                                        >
                                            {customStringJson &&
                                                Object.keys(customStringJson).map((key) => {
                                                    // If the key is an array, put each value on a new line
