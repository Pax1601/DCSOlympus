...
class RadioListener:
    ...
    def transmit_on_frequency(self, file_name: str, frequency: float, modulation: int, encryption: int, **kwargs) -> bool:
        ...
        try:
            loop.create_task(self._send_message(file_name, frequency, modulation, encryption, None, kwargs.get("unit_ID")))
            return True
        except Exception as e:
    ...
    def transmit_on_intercom(self, file_name: str, intercom_ID: int) -> bool:
        ...
        try:
            loop.create_task(self._send_message(file_name, None, None, None, intercom_ID, None))
            return True
        except Exception as e:
