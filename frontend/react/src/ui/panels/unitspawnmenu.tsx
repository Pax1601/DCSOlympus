...
export function UnitSpawnMenu(props: {
  ...
  const updateSpawnRequestTable = useCallback(() => {
    if (props.blueprint !== null) {
      ...
      const loadoutPayload = spawnLoadout ? (props.blueprint.loadouts?.find((loadout) => loadout.name === spawnLoadout.name)?.payload ?? undefined) : undefined;
    ...
    <>
      {props.compact ? (
        <>
          {props.visible && (
            <div
              className={`flex max-h-[800px] flex-col overflow-auto`}
            >
              <div className="mr-2">
                <div className="flex h-fit flex-col gap-2">
                  ...
                  >
                    <div
                      className={`my-auto text-nowrap text-sm text-white`}
                    >
                      Quick access:
                    </div>
                    <OlStringInput
                  ...
                  {["aircraft", "helicopter"].includes(props.blueprint?.category ?? "aircraft") && (
                    <>
                      ...
                      <div
                        className={`flex content-center justify-between gap-2`}
                      >
                        <span
                          className={`
                            my-auto font-normal
                      ...
                      <div
                        className={`
                          flex flex-col content-center justify-between gap-2
                        `}
                      >
                        <span
                          className={`
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`relative mr-3 h-[60px] w-[60px]`}
                      >
        ...
        <>
          ...
          {props.visible && (
            <div className="flex flex-col">
              ...
              <div
                className={`flex h-fit flex-col gap-2 px-5 pb-8 pt-6`}
              >
                <div
                  className={`
                    inline-flex w-full flex-row content-center justify-between
                ...
                >
                  {!props.coalition && (
                    <>
                      <div
                        className={`my-auto mr-2 text-white`}
                      >
                        Coalition:
                      </div>
                      <OlCoalitionToggle
